...
insert into tipoUsuarios(tipos)
...
insert into clinicas(nomeClinica,cnpj,razaoSocial,endereco)
...
insert into usuarios(idTipoUsuario,nome,rg,cpf,email,numeroTel)
...
insert into Agendamentos(IdSituacao,IdPaciente,IdMedico,dataConsulta)
values (2,7,3,'20-1-2020 15:30:00'),
	   (3,2,3, '1-6-2020 10:40:00'),
	   (2,3,2,'2-7-2020 11:10:00'),
	   (2,2,2,'2-6-2018 10:20:00'),
	   (3,4,1,'2-7-2019 11:50:00'),
	   (1,7,3,'3-8-2020 15:50:00'),
	   (1,4,1,'3-9-2020 11:30:00')
